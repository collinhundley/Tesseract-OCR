...
FILES="leptonica-1.80.0 giflib-5.2.1 jpeg-9d libpng-1.6.37 libtiff-4.1.0 openjpeg-2.3.1 little-cms2-2.11 webp-1.1.0 tesseract-4.1.1 curl-7.71.1 openldap-2.4.50"
OS="mojave"
